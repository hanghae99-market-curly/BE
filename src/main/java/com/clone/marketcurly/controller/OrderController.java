...
public class OrderController {
    ...
    public void saveOrder(@RequestBody OrderRequestDto orderRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        //본인이 맞다면, 아니라면..?
        //로그인을 했다면 안했다면..?
        User user = userDetails.getUser();
        orderService.saveOrder(orderRequestDto, userDetails);
